<div class="grid grid-cols-12">
	<h1 class="col-span-6 md:col-span-4 text-2xl">Edit <?= $person->first_name ?></h1>
	...
	<div class="col-span-12 mt-6">
		<?php echo form_open("people/edit/$person->id", ['class' => 'grid grid-cols-12 gap-2']); ?>
			...
			<div class="mb-5 col-span-12">
				...
				<textarea name="notes" rows="6" class="block p-2.5 w-full text-sm text-gray-800 bg-white rounded-lg border border-gray-300 focus:ring-purple-500 focus:border-purple-500" placeholder="Notes..."><?= $person->notes?></textarea>
			</div>
